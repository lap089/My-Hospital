 ...
 */
function finalproject_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['finalproject_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('finalproject sample setting'),
  '#default_value' => theme_get_setting('finalproject_example'),
